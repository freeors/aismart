...
#ifndef GUI_DIALOGS_RESETPWD_HPP_INCLUDED
#define GUI_DIALOGS_RESETPWD_HPP_INCLUDED
 ...
 */
class tresetpwd : public tdialog
{
public:
	tresetpwd(bool bind);
...
private:
	...
	void set_reset_active(const std::string& mobile, const std::string& email, const std::string& password);
