...
/*
static const char* kDefaultSvmPath = "C:/ddksample/apps-res/app-aismart/model/svm_hist.xml";
static const char* kLBPSvmPath = "C:/ddksample/apps-res/app-aismart/model/svm_lbp.xml";
static const char* kHistSvmPath = "C:/ddksample/apps-res/app-aismart/model/svm_hist.xml";

static const char* kDefaultAnnPath = "C:/ddksample/apps-res/app-aismart/model/ann.xml";
static const char* kChineseAnnPath = "C:/ddksample/apps-res/app-aismart/model/ann_chinese.xml";
static const char* kGrayAnnPath = "C:/ddksample/apps-res/app-aismart/model/annCh.xml";

//This is important to for key transform to chinese
static const char* kChineseMappingPath = "C:/ddksample/apps-res/app-aismart/model/province_mapping";
*/
extern std::string kDefaultSvmPath;
extern std::string kLBPSvmPath;
extern std::string kHistSvmPath;

extern std::string kDefaultAnnPath;
extern std::string kChineseAnnPath;
extern std::string kGrayAnnPath;

//This is important to for key transform to chinese
extern std::string kChineseMappingPath;
