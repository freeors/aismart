...
void init(const std::string& _app, const std::string& channel, bool landscape)
{
...
#ifdef _WIN32
	// statusbar_height = 10 * gui2::twidget::hdpi_scale; // for debug
#endif
	...
	const int CFG_SIZE_DEFAULT = 16;
#else
	const int CFG_SIZE_DEFAULT = 13; // i think, win10 is 13
#endif

	font::SIZE_SMALLEST = (CFG_SIZE_DEFAULT - 6) * gui2::twidget::hdpi_scale;
	font::SIZE_SMALLER = (CFG_SIZE_DEFAULT - 4) * gui2::twidget::hdpi_scale;
	font::SIZE_SMALL = (CFG_SIZE_DEFAULT - 2) * gui2::twidget::hdpi_scale;
	font::SIZE_DEFAULT = CFG_SIZE_DEFAULT * gui2::twidget::hdpi_scale;
	font::SIZE_LARGE = (CFG_SIZE_DEFAULT + 2) * gui2::twidget::hdpi_scale;
	font::SIZE_LARGER = (CFG_SIZE_DEFAULT + 4) * gui2::twidget::hdpi_scale;
	font::SIZE_LARGEST = (CFG_SIZE_DEFAULT + 6) * gui2::twidget::hdpi_scale;
