...
void tmessage::pre_show()
{
	...
	tmessage_implementation::
			init_button(*window_, buttons_[cancel], "cancel");
	tmessage_implementation::
			init_button(*window_, buttons_[ok] ,"ok");
...
void show_error_message(const std::string& message, bool message_use_markup)
{
	show_message(_("Error"), message, tmessage::ok_button, "hero-256/0.png", "");
}
