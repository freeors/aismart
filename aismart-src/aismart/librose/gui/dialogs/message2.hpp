...
{
public:
	tmessage2(const std::string& message, const std::string& ok_caption = null_str, const std::string& cancel_caption = null_str);
...
int show_message2(const std::string& message, const std::string& ok_caption = null_str, const std::string& cancel_caption = null_str);
